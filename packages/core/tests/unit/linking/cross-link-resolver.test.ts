...
import { CrossLinkResolver } from '../../../src/linking/cross-link-resolver.js';
import { ArticleIndex } from '../../../src/linking/article-index.js';
import { Slug, type Article } from '../../../src/publishing/index.js';

describe('CrossLinkResolver', () => {
  const createArticle = (slugStr: string, title: string, aliases: string[] = []): Article => ({
